...
class ApiV2
{
    ...
    function ChatAddMessage()
    {
        ...
        $post = new Post($id,$chat->SystemId,"",$message->Text,time(),$chat->ChatId,$visitor->VisitorData->Fullname);
    ...
    static function GetObjectFields($_objName)
    {
        ...
        if($_objName=="Chat")
            return array(
                ...
                "Email"=>array("Input"=>true,"Output"=>false,"Type"=>"string","Description"=>"User email","Required"=>false,"Example"=>"john@doe.com"),
